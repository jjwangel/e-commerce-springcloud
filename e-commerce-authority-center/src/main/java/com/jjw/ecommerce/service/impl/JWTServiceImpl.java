...
import com.jjw.ecommerce.CommonConstant;
import com.jjw.ecommerce.constant.AuthorityConstant;
import com.jjw.ecommerce.domain.entity.EcommerceUser;
import com.jjw.ecommerce.service.IEcommerceUserService;
import com.jjw.ecommerce.service.IJWTService;
import com.jjw.ecommerce.vo.LoginUserInfo;
...
public class JWTServiceImpl implements IJWTService {
    ...
    @Autowired
    private IEcommerceUserService iEcommerceUserService;
    ...
    public String generateToken(String username, String password, int expire) throws Exception {
        ...
        QueryWrapper queryWrapper = new QueryWrapper<EcommerceUser>();
        queryWrapper.eq("username", username);
        queryWrapper.eq("password", password);

        EcommerceUser ecommerceUser = this.iEcommerceUserService.getOne(queryWrapper);
    ...
    public String registerUserAndGenerateToken(UsernameAndPassword usernameAndPassword) throws Exception {
        ...
        // 注册一个新用户, 写一条记录到数据表中
        this.iEcommerceUserService.save(ecommerceUser);
